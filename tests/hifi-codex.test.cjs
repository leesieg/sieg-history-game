...
const codexText = JSON.stringify(codex.concepts) + JSON.stringify(codex.decisions);
assert.doesNotMatch(codexText, /政治改革|军事改革|财政改革|改革槽|advanceReform/, "百科不应残留旧改革槽 / 改革等级口径");
assert.doesNotMatch(codexText, /旧法律|laws/, "百科不应残留旧法律口径");
